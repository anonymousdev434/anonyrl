...
include["lulesh.cc"]["function"]["CalcElemVelocityGradient"] = ["b", "xvel", "yvel", "zvel", "d", "pfx", "pfy", "pfz"]
include["lulesh.cc"]["function"]["CalcElemShapeFunctionDerivatives"] = ["x", "y", "z", "b", "volume"]
include["lulesh.cc"]["function"]["CalcElemCharacteristicLength"] = ["x", "y", "z", "a", "charLength"]
...
include["lulesh.cc"]["function"]["SumElemFaceNormal"] = ["normalX0", "normalY0", "normalZ0", "normalX1", "normalY1", "normalZ1", "normalX2", "normalY2", "normalZ2", "normalX3", "normalY3", "normalZ3"]
...
include["lulesh.cc"]["function"]["VoluDer"] = ["dvdx", "dvdy", "dvdz"]
...
include["lulesh.cc"]["function"]["CalcKinematicsForElems"] = ["B", "D", "x_local", "y_local", "z_local", "xd_local", "yd_local", "zd_local", "detJ"]
...
include["lulesh.cc"]["function"]["EvalEOSForElems"] = ["vnewc", "e_old", "delvc", "p_old", "q_old", "compression", "compHalfStep", "qq_old", "ql_old", "work", "p_new", "e_new", "q_new", "bvc", "pbvc", "pHalfStep"]
...
include["lulesh.cc"]["function"]["CalcPressureForElems"] = ["p_new", "bvc", "pbvc", "e_old", "compression", "vnewc"]
include["lulesh.cc"]["function"]["CalcSoundSpeedForElems"] = ["vnewc", "enewc", "pnewc", "pbvc", "bvc"]
