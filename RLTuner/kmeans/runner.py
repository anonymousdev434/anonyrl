...
def run_config(state_num):
    ...
    if os.path.exists(TO_RUN):
        ...
        try:
            ...
            process.kill()
        os.system(f"../../utilities/quality -a accurate_output -t test_output -m MPP -e {B_EPSILON}")
...
def run_orig_config(original_config):
    ...
    if os.path.exists(TO_RUN):
        ...
        try:
            ...
            print('Timed out - killing', process.pid)
            process.kill()
        os.system(f"../../utilities/quality -a accurate_output -t accurate_output -m MPP -e {B_EPSILON}")
